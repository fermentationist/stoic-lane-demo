...
const generalRateLimitConfig = {
  ...
  message: {status: "failed", error: {name: "Rate limit exceeded", message: `Maximum of ${rate} requests per minute.`}}
}
...
const userRateLimitConfig = {
  ...
  standardHeaders: true,
  message: {status: "failed", error: {name: "Rate limit exceeded", message: `Too many requests from this user. Maximum of ${userRate} per minute.`}},
...
export default [generalRateLimiter, userRateLimiter];